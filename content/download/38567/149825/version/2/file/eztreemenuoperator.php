...
class eZTreeMenuOperator
{
    ...
    */
    function modify( &$tpl, &$operatorName, &$operatorParameters, &$rootNamespace, &$currentNamespace, &$operatorValue, &$namedParameters )
    {
        ...
        $sortBy = $namedParameters['sort_by'];
        ...
        while ( !$done )
        {
            ...
            if (!$sortBy && is_object($node))
                $childrenSortBy = $node->attribute("sort_array");
            else
                $childrenSortBy = $sortBy;
            ...
            else
            {
                if ( $level == 0 )
                {
                    ...
                    if (!$sortBy)
                    {
                        ...
                        $rootSortBy=$rootNode->attribute("sort_array");
                    }
                    else
                        $rootSortBy=$sortBy;
